...
export default function Finder() {
  ...
  return (
    <section id="find" className="py-20 md:py-72 flex flex-col w-full relative overflow-hidden">
      <Icons.topography className="absolute text-secondary top-0 opacity-70 scale-125" />

      <div className="container flex flex-col gap-8 md:gap-20 items-center">
        <h2 className="w-full z-10 text-5xl font-semibold text-center">
