    ...
    <div className="flex flex-col gap-6 text-primary-400 col-span-5">
      ...
      <div className="flex flex-col gap-3 text-primary-300">
        <input
          ...
          className=" mt-1 block w-full p-2 border border-primary-400 rounded-md shadow-sm"
          value={email}
      ...
      <button
        type="button"
        arial-label="Suscribirse"
        onClick={handleSubscribe}
        className=" p-2 justify-center !rounded-full self-start px-8 card-style flex items-center gap-2"
