...
export default function DesktopHeader() {
  return (
    ...
    <section className="hidden  relative overflow-hidden md:py-80 py-40 w-full justify-center self-center md:flex-row md:flex flex-col md:gap-10 gap-20  items-center">
    <Boxes />
